                    ...
                    <tr class="bg-white border-b">
                        ...
                        <td >
                            <div class="flex float-right gap-10">
                                <a href="{{ route('pegawai.show',$data) }}" class="transition-all duration-200 ease-in-out hover:text-blue-600"><i class="fa-solid fa-eye"></i></a>
                                <a href="{{ route('pegawai.edit',$data) }}" class="transition-all duration-200 ease-in-out hover:text-green-600"><i class="fa-solid fa-pen-to-square"></i></a>
                                <form action="{{ route('pegawai.destroy',$data) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
